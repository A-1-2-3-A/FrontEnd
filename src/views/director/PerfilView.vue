<template>
	<section class="container mt-4 d-flex flex-column align-items-center">
		...
		<!-- Recuadro: Información del perfil -->
		<div class="card shadow mb-4 w-100" style="max-width: 600px;">
			...
			<div class="card-body">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" value="Fernández Ríos" disabled>
				</div>
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" value="2023 - 2025" disabled>
				</div>
				<div class="mb-3">
					<label class="form-label text-start w-100">Fecha de registro</label>
					<input type="text" class="form-control" value="10 de abril de 2023" disabled>
				</div>
			</div>
		</div>
